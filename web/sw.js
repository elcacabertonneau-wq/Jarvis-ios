...
const SHELL = [
  ...
  'js/app.js', 'js/ar.js', 'js/arlayers.js', 'js/geo.js', 'js/brain.js', 'js/camera.js', 'js/draw.js', 'js/facts.js', 'js/hands.js', 'js/intents.js', 'js/markdown.js', 'js/mindmap.js', 'js/player.js',
